...
//Application Title
define('APP_TITLE', 'AVD File Manager');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://www.linkedin.com/in/deep-panchal369/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Deep Panchal</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a target="_blank" class="app-v-title"> AVD File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Deep Panchal</p>
                        <p>Mail Us: <a href="mailto:deep.pd.42000@gmail.com">deep.pd.42000@gmail.com</a> </p>
                    </div>
                </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a   target="_blank" class="float-right text-muted">AVD File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a   target="_blank" class="float-right text-muted">AVD File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'AVD File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with AVD File Manager">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'AVD File Manager';      $tr['en']['AppTitle']           = 'File Manager';
